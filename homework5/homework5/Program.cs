...
namespace Program2
{
    ...
    class Ordermanage//订单管理类
    {
        ...
        public Order Search(int Onum)
        {
            ...
            var order = from ord in Orders where ord.Onum == Onum select ord;
            return order.First();
        ...
        public static Order Search(string Oname)
        {
            ...
            var order = from ord in Orders where ord.Oname == Oname select ord;
            return order.First();
        }
    }
    class Operate//用户操作类
            ...
            do
            {
                ...
                switch (number)
                {
                    ...
                    case 5:
                        ...
                        Order orde = Ordermanage.Search(Oname);
                         myOrdermanage.ShowOrderInfo(orde);
